...
import { FaAngleLeft, FaAngleRight, FaHeart, FaAngleUp } from 'react-icons/fa'
...
export default function ArticleDetail() {
  ...
  const handleCommentSubmit = async () => {
    ...
    try {
      ...
      console.error('留言發送失敗:', error.message)
      Swal.fire({
        icon: 'error',
        title: '錯誤',
        text: '留言發送失敗，請稍後重試',
  ...
  useEffect(() => {
    ...
    const fetchLatestArticles = async () => {
      try {
        ...
        console.error('無法獲取最新文章:', error.message)
      }
    }
    fetchArticle()
    fetchLatestArticles()
                          ...
                          >
                            ...
                            >
                              <div className={`${styles['time']}`}>
                                {messsageDate(comment.create_time)}
                              </div>
                          ...
                          <React.Fragment key={reply.id}>
                            <div className={`d-flex ${styles['commentReply']}`}>
                              ...
                              >
                                ...
                                >
                                  <div className={`${styles['time']}`}>
                                    {messsageDate(reply.create_time)}
                                  </div>
                                  <div className={`${styles['messageReply']}`}>
                                    <button
                                      onClick={() =>
