...
export default function Login() {
  ...
  return (
    <div id={`${styles['login']}`}>
      ...
      <img src={xxx.src} className={`${styles['bg-img']}  ${styles['xxx']}`} />

      {/* 上下移動的圖片 */}
      <img
        src={bg_fidex.src}
        className={`${styles['bg-img']}  ${styles['bg-fidex']}`}
      />

      {/* 背景圖片 */}
      <img
        src={bg_3.src}
        className={`${styles['bg-img']}  ${styles['bg-1']}`}
      />
      <img
        src={bg_2.src}
        className={`${styles['bg-img']}  ${styles['bg-2']}`}
      />
      <img
        src={bg_1.src}
        className={`${styles['bg-img']}  ${styles['bg-3']}`}
      />
      <img
        src={bg_4.src}
        className={`${styles['bg-img']}  ${styles['bg-4']}`}
      />
