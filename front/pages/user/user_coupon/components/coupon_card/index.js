  ...
  return (
    <div className="col-12 col-lg-6">
      <div id={`${styles['coupon']}`} className="d-flex m-3">
        ...
        <div className={` ${styles['card-content']} px-3 py-2 pb-1`}>
          <div className="d-flex justify-content-between">
            <div className="d-flex">
              {/* 判斷折扣的 type */}
              {coupon.type === 'percent' ? (
                <p className={`${styles['discount-number']} mb-2`}>
                  <span>{coupon.value * 10}</span>折
                </p>
              ) : (
                <p
                  className={`${styles['discount-number']} d-flex align-items-end mb-2 mt-0`}
                >
