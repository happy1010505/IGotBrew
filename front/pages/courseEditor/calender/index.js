...
export default function Calender() {
  //日曆
  const { bschedule, location, courses, deleteSchedule, fetchBackSchedules } =
    useCourseApi()
  ...
  useEffect(() => {
    const loadSchedules = async () => {
      try {
        ...
        console.log('Fetched schedules:', bschedule) // 確認 schedule 是否包含所有排程
      } catch (error) {
