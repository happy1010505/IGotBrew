...
export default function Order() {
  ...
  const doCheckboxChangeAdd = () => {
    setIsCheckedAdd(!isCheckedAdd)
    if (!isCheckedAdd) {
      setFormData((prevFormData) => ({
        ...prevFormData,
  ...
  const cityAreaPostalHidden = isCheckedAdd ? { display: 'none' } : {}
  const doChange = (e) => {
    setFormData({
      ...formData,
                  ...
                  <div>
                    {formData.ship_method === '1' && (
                      <div className="row g-0 gap-3">
                        <div
                          className="col-auto g-0 mt-2 mb-2"
                          style={cityAreaPostalHidden}
                        >
